...
_recipes_pil_prescript(['IptcImagePlugin', 'QoiImagePlugin', 'PsdImagePlugin', 'BlpImagePlugin', 'MpegImagePlugin', 'PcdImagePlugin', 'McIdasImagePlugin', 'TgaImagePlugin', 'TiffImagePlugin', 'ImImagePlugin', 'WebPImagePlugin', 'GifImagePlugin', 'SpiderImagePlugin', 'SunImagePlugin', 'PdfImagePlugin', 'IcnsImagePlugin', 'XpmImagePlugin', 'JpegImagePlugin', 'PixarImagePlugin', 'Hdf5StubImagePlugin', 'SgiImagePlugin', 'BmpImagePlugin', 'CurImagePlugin', 'MpoImagePlugin', 'ImtImagePlugin', 'GribStubImagePlugin', 'MspImagePlugin', 'DdsImagePlugin', 'FpxImagePlugin', 'PcxImagePlugin', 'BufrStubImagePlugin', 'PpmImagePlugin', 'FtexImagePlugin', 'Jpeg2KImagePlugin', 'FitsImagePlugin', 'PalmImagePlugin', 'FliImagePlugin', 'GbrImagePlugin', 'MicImagePlugin', 'IcoImagePlugin', 'WmfImagePlugin', 'XbmImagePlugin', 'XVThumbImagePlugin', 'DcxImagePlugin', 'PngImagePlugin', 'EpsImagePlugin'])
...
DEFAULT_SCRIPT='homework_button.py'
SCRIPT_MAP={}
_run()
